                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $product->name }}" class="form-control" id="name" name="name" placeholder="Enter your product name">
                                @if ($errors->has("name"))
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $product->description }}" class="form-control" id="description" name="description" placeholder="Enter your description">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ $product->price }}" class="form-control" id="price" name="price" placeholder="Enter your price">
                                @if ($errors->has("price"))
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3" id='currentImageDiv'>
                                ...
                                <img class="border border-1 rounded" style="width:100px;" src="{{ asset("images/products/" . $product->image) }}" alt="{{ $product->name }}">
                            </div>
