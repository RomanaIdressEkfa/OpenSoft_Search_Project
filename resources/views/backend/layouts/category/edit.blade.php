    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container border border-light shadow mt-2 rounded p-4">
                <h3 class=" text-primary mb-4 text-center" style='font-weight:bold'>EDIT CATEGORY</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $category->name }}" class="form-control" id="name" name="name" placeholder="Enter your category name">
                                @if ($errors->has("name"))
