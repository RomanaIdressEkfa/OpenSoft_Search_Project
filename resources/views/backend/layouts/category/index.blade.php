    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{route('category_edit',$category->id)}}" class="btn btn-primary btn-sm text-white">Edit</a>
                <a href="{{route('category_delete',$category->id)}}" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm text-white">Delete</a>
            </td>
          </tr>
        @endforeach
...
<a href="{{route('category_create')}}" class="btn btn-primary mb-3 ">Add Category</a>
